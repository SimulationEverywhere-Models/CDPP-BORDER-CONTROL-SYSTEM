...
/** include files **/
#include "VehicleQueryPerformerType.h"           // base header
...
/*******************************************************************
* Function Name: VehicleQueryPerformerType
* Description: constructor
********************************************************************/
VehicleQueryPerformerType::VehicleQueryPerformerType( const string &name )
: Atomic( name )
// TODO: add ports here if needed (Remember to add them to the .h file also). Each in a new line.
// Ej:
, VQPOut(addOutputPort( "VQPOut" ))
, trafficIn(addInputPort( "trafficIn" ))
{
...
********************************************************************/
Model &VehicleQueryPerformerType::initFunction()
{
	this->passivate();
	return *this ;
}
...
********************************************************************/
Model &VehicleQueryPerformerType::externalFunction( const ExternalMessage &msg )
{
	int randMinute = int(rand() % 1 + 1); //range 1-2
...
********************************************************************/
Model &VehicleQueryPerformerType::internalFunction( const InternalMessage & )
{
 	passivate();
	return *this;
}
...
********************************************************************/
Model &VehicleQueryPerformerType::outputFunction( const InternalMessage &msg )
{
	...
	{
		this->sendOutput( msg.time(), VQPOut, 1 ) ;
	}
	else
	{
		this->sendOutput( msg.time(), VQPOut, 0 ) ;
	}
...
VehicleQueryPerformerType::~VehicleQueryPerformerType()
{
